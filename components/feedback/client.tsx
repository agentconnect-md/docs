...
const rateButtonVariants = cva(
  'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full font-medium border text-sm [&_svg]:size-4 disabled:cursor-not-allowed',
  {
    variants: {
      active: {
      ...
      <CollapsibleContent className="mt-3">
        {previous ? (
          ...
          <form className="flex flex-col gap-3" onSubmit={submit}>
            ...
            <button
              type="submit"
              className={cn(buttonVariants({ variant: 'outline' }), 'w-fit px-3 py-1')}
              disabled={isPending}
            >
              Submit
            </button>
