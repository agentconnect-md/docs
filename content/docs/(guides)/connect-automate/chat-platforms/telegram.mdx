...
title: "Telegram"
icon: Telegram
description: "One token from @BotFather and your agent answers Telegram DMs and groups."
---
...
<Image src={imgTelegramIntegration} alt="Connect a Telegram bot" width={640} />
