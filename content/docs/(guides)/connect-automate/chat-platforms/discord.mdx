...
title: "Discord"
icon: Discord
description: "Create a Discord application, paste its bot token, and use AgentConnect's ready-made server invite."
---
...
<Image src={imgDiscordIntegration} alt="Connect a Discord bot" width={640} />
...
Mention the bot in a server channel it can see and it answers; longer conversations continue in threads. You can also send it a direct message. AgentConnect registers its [in-conversation commands](/connect-automate/integrations-overview#in-conversation-commands) as native Discord slash commands.
