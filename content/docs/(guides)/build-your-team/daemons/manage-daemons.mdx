...
icon: ServerCog
description: "Monitor daemon health, maintain services, move agents safely between machines, and run agents on AgentConnect Cloud."
---
...
- **Usage is deducted from your organization's prepaid credit balance.** Owners add credits on the **Billing** page. See [Billing & usage](/operate-govern/billing-and-usage) for the balance, the ledger, and the Analytics view behind it.
