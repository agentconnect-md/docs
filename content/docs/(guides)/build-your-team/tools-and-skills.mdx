...
title: "Tools & Skills"
icon: Wrench
description: "Register shared capabilities once, then enable the right tools and skills for each agent."
---
...
<Image src={imgToolsSkills} alt="Organization connectors, MCP servers, and skills" width={900} />
...
<Image src={imgMcpServer} alt="Register a custom MCP server" width={520} />
...
![Import a Git repository as a skill source](/images/skills-import.png)
...
<Image src={imgAgentToolsSkills} alt="An agent's Tools & Skills tab: MCP servers and skill sources switched on per agent" width={820} />
