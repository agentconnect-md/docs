...
<Cards>
  <Card kind="tile" title="Install the daemon" href="/docs/install-the-daemon" icon="fa-duotone fa-server">Run agents on any macOS, Linux, or Windows machine with Node 24.12+</Card>
