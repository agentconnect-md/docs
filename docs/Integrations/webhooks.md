...
The request body **is** the message the agent receives (`application/json`, up to 128 KiB; very long bodies are excerpted in the trigger and the agent can fetch the rest):
