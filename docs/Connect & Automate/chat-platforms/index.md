...
Connect agents to [Slack](/docs/slack), [Telegram](/docs/telegram), [Discord](/docs/discord), or [Lark / Feishu](/docs/lark-feishu). A self-hosted deployment can also connect [QQ](/docs/qq). Each integration binds an agent to a bot and a set of conversations.
