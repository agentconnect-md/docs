...
Everything the console does rides a REST API at `https://api.agentconnect.md` — and you can call it yourself. On [AgentConnect OSS](/docs/get-started), the same API is served at your deployment's Control Plane URL. A **personal API key** authenticates as *you*, with *your role*, in **one organization**.
