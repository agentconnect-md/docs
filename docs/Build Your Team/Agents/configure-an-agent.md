...
<p align="center">
  <img src="https://raw.githubusercontent.com/agentconnect-md/docs/HEAD/images/agent-runtime.png" alt="Edit, with the Execution strategy picker open on Host, Sandbox and VM" width="560" />
</p>
...
Choose another daemon or [daemon group](/docs/daemon-groups) in **Runs on** in **Edit** to move the agent. The target must be online and support the selected runtime, model, tools, and skills. While the move is pending, the **Execution strategy** picker is locked; save the move first, then change the strategy.
